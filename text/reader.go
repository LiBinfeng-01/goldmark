...
type Reader interface {
	...
	ReleaseHistoryWindow(outdatedIndex int)
...
func (r *reader) BufferWindow() *BufferWindow {
	return nil
}
...
func (r *reader) ReleaseHistoryWindow(outdatedIndex int) {}
...
func (r *blockReader) BufferWindow() *BufferWindow {
	return nil
}
...
func (r *blockReader) ReleaseHistoryWindow(outdatedIndex int) {}
